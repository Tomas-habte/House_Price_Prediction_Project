...
-  The main challenge we faced while choosing the dataset is that the topics we found interesting had complex data that required a lot of cleaning or was difficult to find. Therefore, we searched for data that was reasonably easy to work with. While our dataset only contained data spanning 5 months ending in Decemeber 2022, we wanted to use it as this was very recent and can give us good insights. 
**Technologies**
